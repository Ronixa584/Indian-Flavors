...
const Header = () => {
  ...
  const { location, setLocation } = useCity();

  // Retrieve location from localStorage on mount
  useEffect(() => {
  ...
  return (
    // <cityContext.Provider value={location}>
    <header className="bg-gradient-to-r from-green-100 via-white-800 to-red-100">
      <div className="global-nav">
        <div className="flex justify-between p-4 flex-wrap md:flex-nowrap">
          <div className="flex justify-start gap-4 md:gap-10 flex-wrap md:flex-nowrap w-full md:w-auto">
            <Title />
            {/* </a> */}
            {location ? (
              <div
              ...
              >
                ...
                <span className="icon-downArrow bg-black"></span>
              </div>
            ) : (
              <div
                role="button"
          ...
          <div className="mt-4 md:mt-0 flex flex-wrap gap-4 justify-between items-center">
            <ul className="flex flex-wrap gap-4 justify-between items-center">
              ...
              {isLoggedIn ? (
                <li className="_1fo6c">
                  <div className="_2CgXb flex gap-2">
                    <a className="_1T-E4 flex gap-2">
                      ...
                      <Link className="_1T-E4 flex gap-2" to="/cart">
                        <span className="_3yZyp flex justify-center items-center">
                          ...
                          >
                            ...
                            <span className="_2vS77 bg-white"></span>
                          </svg>
                        </span>
