  ...
  return (
    ...
    <header className="_76q0O ">
      <div className="global-nav">
        <div className="_1EuBh flex justify-between p-4">
          <div className="flex justify-start gap-10">
            ...
            {location ? (
              <div
                role="button"
                className="_2z2N5 flex justify-center items-center"
                // tabindex="0"
                onClick={handleLocationClick}
              >
                <span className="_1tcx6 flex justify-center items-center gap-2">
                  <span>
                    <AiFillEnvironment />
                  </span>
                  <span className="_3odgy">{location}</span>
                </span>
                <span className="_3HusE"></span>
                <span className="icon-downArrow kVKTT bg-black"></span>
              </div>
            ) : (
              <div
                role="button"
              ...
              >
                <span className="_1tcx6 flex justify-center items-center gap-2">
                  ...
                  <span className="_3odgy">Get Current Location</span>
                </span>
                <span className="_3HusE"></span>
                <span className="icon-downArrow kVKTT bg-black"></span>
              </div>
          ...
          <div className="">
            <ul className="_1JNGZ flex space-x-4 mt-4  gap-10 justify-between items-center ">
              {/* <li className="_1fo6c">
                <div className="_2CgXb ">
                  <a className="_1T-E4 flex gap-2" href="/">
              ...
              <li className="_1fo6c">
                <div className="_2CgXb">
                  <a className="_1T-E4 flex gap-2" href="/About">
                    <span className="_3yZyp flex justify-center items-center">
                      <svg
                        className="_1GTCc"
                        viewBox="6 -1 12 25"
              ...
              <li className="_1fo6c">
                <div className="_2CgXb">
                  <a className="_1T-E4 flex gap-2" href="/Contact">
                    <span className="_3yZyp flex justify-center items-center">
                      <svg
                        className="_1GTCc"
                        viewBox="6 -1 12 25"
              ...
              {/* <li className="_1fo6c">
                <div className="_2CgXb">
                  <a className="_1T-E4" href="/about-us" target="_blank">
                    <span className="_3yZyp">
                      <svg
                        className="_1GTCc"
                        viewBox="0 0 20 20"
              ...
              <li className="_1fo6c">
                <div className="_1fmVk _30y3a">
                  <div>
                    <div className="_2CgXb">
                      <a className="_1T-E4 flex gap-2" href="/checkout">
                        <span className="_3yZyp flex justify-center items-center">
                          <svg
                          ...
                          >
                            ...
                            <span className="_2vS77 bg-white">
                              {cartItems.length}
                            </span>
                          </svg>
                        </span>
